...
project_directory = script_directory.replace('\\runs\\run_deep_k0', '')
...
for ti in t:
    ...
    if Plot_Ticker >= Plot_interval - 0.0000000001:
        ...
        if Net_Erosion_Map == True:
            ...
            imshow_grid(mg, net_erosion , grid_units=("m", "m"), var_name="Chi Index", cmap="jet")
        ...
        if Net_DZ_Map == True:
            ...
            imshow_grid(mg, net_dz, grid_units=("m", "m"), var_name="Chi Index", cmap="jet")
            title_text = '$Year$='+str(total_time_r)  
            plt.title(title_text)
            plt.tight_layout()
